  ...
  return (
    <section id="top" className="relative overflow-hidden pt-32 pb-16 md:pt-40 md:pb-24">
      ...
      <Container className="relative">
        <Reveal>
          <span className="inline-flex items-center gap-2 rounded-full border border-brand/30 bg-background/70 px-3 py-1.5 text-xs uppercase tracking-[0.22em] text-brand-deep backdrop-blur">
          ...
          <div>
            <h1 className="font-display text-[2.75rem] leading-[1] tracking-tight sm:text-6xl md:text-[5.25rem]">
              ...
              <Reveal y={40} delay={0.1}>
                <span className="mt-1 block italic text-gradient-brand">
                  {hero.headlineAccent}
                </span>
              </Reveal>
            </h1>
          ...
          <div className="md:pb-3">
            ...
            <Reveal delay={0.28}>
              <div className="mt-6 flex flex-wrap items-center gap-3">
                <Button
                  size="lg"
                  className="group rounded-full gradient-brand px-6 text-white hover:opacity-90"
        ...
        <motion.div
          ...
          className="relative mt-14 overflow-hidden rounded-3xl border border-border shadow-[0_30px_80px_-30px_rgba(7,72,159,0.35)]"
